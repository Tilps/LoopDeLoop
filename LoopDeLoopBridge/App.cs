...
namespace LoopDeLoopBridge
{
    public class App
    {
        ...
        public static void Main()
        {
            ...
            typePicker.Options[1].Text = "Square Symmetrical";
            typePicker.Options[2].Text = "Triangle";
            typePicker.Options[3].Text = "Hexagon";
            typePicker.Options[4].Text = "Hexagon2";
            typePicker.Options[5].Text = "Hexagon3";
            typePicker.Options[6].Text = "Octagon";
            typePicker.Options[7].Text = "Square2";
            typePicker.Options[8].Text = "Pentagon";
            ...
            display.Mesh = new Mesh(10, 10, MeshType.Hexagonal);
...
self.onmessage = function(e) { 
  if (e.data.href) {
    ...
    LoopDeLoopBridge.WorkerSpawn.WorkerSpawn_OnMessage(e);
            ...
            worker.PostMessage(new InitialReuqest() { href = to_load });
            to_load = Window.Location.Href.Substring(0, Window.Location.Href.LastIndexOf('/') + 1) + "WorkerSpawn.min.js";
            worker.PostMessage(new InitialReuqest() { href = to_load });
            to_load = Window.Location.Href.Substring(0, Window.Location.Href.LastIndexOf('/') + 1) + "LoopDeLoopBridge.min.js";
            worker.PostMessage(new InitialReuqest() { href = to_load });
            to_load = Window.Location.Href.Substring(0, Window.Location.Href.LastIndexOf('/') + 1) + "LoopDeLoopBridge.meta.min.js";
            worker.PostMessage(new InitialReuqest() { href = to_load });
